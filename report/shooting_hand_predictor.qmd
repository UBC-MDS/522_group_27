...
We currently lack hyperparameter optimization and could perform this for future models to improve our model. This could allow us to increase the predicting power of the model with little effort as we could use the data we already have and try out different hyperparameter combinations to find one that increases our model's scores. 
