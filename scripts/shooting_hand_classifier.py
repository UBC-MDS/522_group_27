...
def main(training_data, preprocessor, columns_to_drop, pipeline_to, plot_to, seed):
    ...
    # check_feat_feat_corr = FeatureFeatureCorrelation().add_condition_max_number_of_pairs_above_threshold(threshold=0.92,
    #                                                                                                      n_pairs=0)
    ...
    # Save the plot
    plot.save(os.path.join(plot_to, "shooting_hand_prediction.png"), scale_factor=2.0)  
